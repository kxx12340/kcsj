...
public class Pets_toys_table extends Box {
    final int width=850;
     ...
     *
     */
    public Pets_toys_table(JFrame menu) throws SQLException,ClassNotFoundException {
        //垂直布局
    ...
    public Vector<Vector> getInformationInterface() throws SQLException,ClassNotFoundException{
        ...
        String id,type,color,price,Sales_status=null;
        while(rs.next()){
