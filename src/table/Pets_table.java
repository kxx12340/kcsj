...
public class Pets_table extends Box {
    final int width=850;
     ...
     *
     */
    public Pets_table(JFrame menu) throws SQLException,ClassNotFoundException {
        //垂直布局
    ...
    public Vector<Vector> getInformationInterface() throws SQLException,ClassNotFoundException{
        ...
        String id,name,age,color,race,price,Sales_status=null;
        while(rs.next()){
